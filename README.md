...
И тут вы мне скажете: "Но... Можно же использовать словари...", и вы будете правы, до тех пор, пока для этого фокуса вам нужно использовать до 2-х списков, по сути алгоритм общего индекса - база данных на коленке.
