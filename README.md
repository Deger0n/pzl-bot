...
Но... Можно же использовать словари... И вы будете правы, до тех пор, пока вы используете до 2-х списков с подобными данными, по сути алгоритм общего индекса - база данных на коленке.
